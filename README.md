...
Author: Jani Hirvonen @ Complex Software Oy

## Background

This collaboration model is designed as the next practical step for **a solo developer-sized** project to add **shared project knowledge** to the development process.
